...
__conda_setup="$('/home/dorianhenning/miniconda/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/dorianhenning/miniconda/etc/profile.d/conda.sh" ]; then
        . "/home/dorianhenning/miniconda/etc/profile.d/conda.sh"
    else
        export PATH="/home/dorianhenning/miniconda/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
